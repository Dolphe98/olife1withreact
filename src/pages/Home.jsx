...
const blogData = [
  {
    ...
    excerpt: "Exploring the hidden structures of our imagination...",
    date: "15 March 2026",
  ...
  },
  {
    ...
    excerpt: "Why the balance between light and dark is essential...",
  ...
  },
  {
    ...
    excerpt: "Embracing the state of openness...",
...
export default function Home() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 pt-10 md:pt-20 pb-10 space-y-24 md:space-y-32 overflow-hidden">
      
      {/* SECTION 1: HERO - Stacked on mobile, side-by-side on desktop */}
      <div className="flex flex-col md:flex-row items-center gap-12 relative z-10">
        ...
        {/* Images Container: No more overlapping on mobile */}
        <div className="flex-1 relative h-[350px] md:h-[450px] w-full mt-12 md:mt-0 flex justify-center items-center">
          <img src="/olife1.comsection1image1.jpg" alt="Olife Background" className="absolute top-0 right-1/4 md:right-10 w-48 h-64 md:w-64 md:h-80 object-cover rounded-lg shadow-2xl border border-slate-700 opacity-60 md:opacity-80" />
          <img src="/olife1.comsection1image2.jpg" alt="Olife Foreground" className="absolute bottom-0 left-1/4 md:left-10 w-48 h-64 md:w-64 md:h-80 object-cover rounded-lg shadow-[0_0_30px_rgba(8,145,178,0.2)] border border-cyan-900 z-20" />
        </div>
      </div>

      {/* SECTION 2: LATEST FRAGMENTS */}
      <div className="flex flex-col space-y-8 relative z-30 bg-slate-950 pt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {latestFragments.map((fragment) => (
            <Link key={fragment.id} to="/fragments" className="group relative overflow-hidden rounded-lg border border-slate-800 hover:border-cyan-500/50 transition-colors shadow-lg h-64 md:h-72">
      ...
      <div className="flex flex-col md:flex-row items-center bg-slate-900/30 border border-slate-800 rounded-3xl overflow-hidden shadow-2xl">
        ...
        <div className="md:w-3/5 p-8 md:p-12 space-y-6">
          <h2 className="text-3xl font-bold text-slate-100">I am <span className="text-cyan-500">Deroselin Rodolphe</span>.</h2>
      ...
      <footer className="pt-20 border-t border-slate-900 flex flex-col space-y-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-slate-500 text-xs font-bold uppercase tracking-widest">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-[9px] text-slate-700 font-bold uppercase tracking-[0.2em] border-t border-slate-900/50 pt-8 text-center">
